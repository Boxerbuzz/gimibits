...
class Styles {
  ...
  static TextStyle baloo = GoogleFonts.baloo();
  ...
  static InputDecoration getInputDecoration(context, {String helper}) {
    return InputDecoration(
      ...
      enabledBorder: OutlineInputBorder(
        borderSide: BorderSide(width: 0.5, color: AppTheme.getColor(context)),
      ),
