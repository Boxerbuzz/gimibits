...
class TextTransition extends StatefulWidget {
  ...
  TextTransition({this.text, this.textStyle, this.duration, this.width, this.align});
      ...
      child: Stack(
        children: [
          Positioned(
            ...
            child: Text(
              _string0,
              textAlign:widget.align ??TextAlign.end,
              style: widget.textStyle,
            ),
          ),
          if (_string1 != null) ...{
            Positioned(
              top: widget.textStyle.fontSize -
                  (_controller.value * widget.textStyle.fontSize),
              width: width,
